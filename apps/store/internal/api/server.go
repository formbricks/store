...
import (
	...
	custommiddleware "github.com/formbricks/formbricks-rewrite/apps/store/internal/middleware"
...
func NewServer(cfg *config.Config, client *ent.Client, dispatcher *webhook.Dispatcher, enrichmentQueue queue.Queue, logger *slog.Logger) *Server {
	...
	humaConfig := huma.DefaultConfig("Formbricks Store API", "1.0.0")
	humaConfig.Info.Description = `Experience data storage service for the Formbricks ecosystem.

📚 Full Documentation: https://formbricks.com/docs/store
🚀 Quick Start: https://formbricks.com/docs/store/quickstart
...
<html>
  <head>
    <title>Formbricks Store API Documentation</title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Interactive API documentation for Formbricks Store" />
    <style>
      body {
        margin: 0;
        padding: 0;
